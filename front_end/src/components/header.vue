<template>
    <div class="header">
        <div class="label">
            ...
            <span class="title">HRS 酒店管理系统</span>
        ...
        <a-menu v-model="current" mode="horizontal" theme="light">
            ...
            <a-menu-item key="3" @click="selectMenu" v-if="userInfo.userType=='Busi'">
            ...
            <a-menu-item key="4" @click="selectMenu" v-if="userInfo.userType=='Admin'">
                <router-link :to="{ name: 'manageUser'}">
                     <a-icon type="laptop" />系统管理
                </router-link>
            </a-menu-item>
            <a-menu-item key="5" @click="selectMenu" v-if="userInfo.userType=='Staff'">
                <router-link :to="{ name: 'frontDesk'}">
                    <a-icon type="solution" />酒店管理
                </router-link>
            </a-menu-item>
        </a-menu>
        <div class="logout">
...
export default {
    ...
    mounted() {
        if (this.$route.name == 'hotelList' || this.$route.name == 'hotelDetail') {
            ...
            this.current = ['3']
        }else if(this.$route.name == 'frontDesk'){
            this.current=['5']
        }
        else {
            this.current = ['4']
